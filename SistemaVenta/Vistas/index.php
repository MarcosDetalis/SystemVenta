...
<body class="bg-primary">
    ...
    <script src="<?php echo base_url; ?>Acceso/js/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script>
    <script src="<?php echo base_url; ?>Acceso/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
    <script src="<?php echo base_url; ?>Acceso/js/scripts.js"></script>
    <script>
    const base_url ="<?php echo base_url; ?>";
    </script>
    <script src="<?php echo base_url; ?>Acceso/js/login.js"></script>
</body>
